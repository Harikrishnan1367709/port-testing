...
export function VideoPlayerSection() {
  ...
  // Video configuration
  const videoSrc = "https://www.youtube.com/embed/dQw4w9WgXcQ" // Replace with your video URL
  const thumbnailSrc = "https://images.unsplash.com/photo-1611224923853-80b023f02d71?w=800&h=450&fit=crop&crop=center"
  const thumbnailAlt = "GooseD Demo Video"
  ...
  return (
    <section id="demo" className="py-24 bg-black">
      <div className="max-w-7xl mx-auto px-4">
        ...
        >
          <p className="text-sm text-primary mb-4 font-medium">WATCH DEMO</p>
          ...
          <p className="mt-4 text-lg tracking-tight text-muted-foreground max-w-3xl mx-auto">
            Watch how our platform transforms your deployment workflow with powerful tools and seamless integration.
          </p>
        </motion.div>
